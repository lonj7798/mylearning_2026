...
| Quoting one IFEval-style number without the variant | Two reports of the same model differ by 2-9 points | Name the metric: prompt-level or instruction-level, strict or loose ([[ifeval]] Table 3) |
